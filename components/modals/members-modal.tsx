...
import { Check, CheckCheck, Copy, Gavel, Loader2, MoreVertical, RefreshCw, Shield, ShieldAlert, ShieldCheck, ShieldQuestion } from 'lucide-react'
...
function MembersModal() {
    ...
    const roleChange = async (memberId: string, role: MemberRole) => {
        try {
            ...
            // Creating query parameter in URL like "/api/members/wdejhijhbwdj?serverId=wdehuedwi"
                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent side='left'>
                                            <DropdownMenuSub>
                                                ...
                                                <DropdownMenuPortal>
                                                    <DropdownMenuSubContent>
                                                        <DropdownMenuItem onClick={() => roleChange(member.id, 'GUEST')}>
                                                        ...
                                                        <DropdownMenuItem onClick={() => roleChange(member.id, "MODERATOR")}>
