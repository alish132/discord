...
import { Member, Profile, Server } from '@/lib/generated/prisma/browser'
...
function ServerMember({member, server}: ServerMemberProps) {
  ...
  return (
    <button onClick={redirectUser} className={cn("group px-2 py-2 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1", params.id === member.id && "bg-zinc-700/20 dark:bg-zinc-700")}>
        <UserAvatar
